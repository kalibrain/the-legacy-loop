...
export default function CollectionCompletePage() {
  ...
  return (
    <section className="space-y-6">
      <header>
        <h1 className="text-3xl font-bold text-slate-900">Data Collection Complete</h1>
      ...
      <div className="card-surface rounded-xl p-6">
        <h2 className="text-lg font-semibold text-slate-900">Collection Summary</h2>
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
            <p className="text-xs uppercase tracking-wide text-slate-500">Files Processed</p>
            <p className="mt-1 text-2xl font-bold text-slate-900">
              {state.collection.stats?.filesProcessed ?? 0}
            </p>
          </div>
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
            <p className="text-xs uppercase tracking-wide text-slate-500">Messages Indexed</p>
            <p className="mt-1 text-2xl font-bold text-slate-900">
              {state.collection.stats?.messagesIndexed ?? 0}
            </p>
          </div>
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
            <p className="text-xs uppercase tracking-wide text-slate-500">Tickets Indexed</p>
            <p className="mt-1 text-2xl font-bold text-slate-900">
      ...
      <div className="card-surface rounded-xl p-6">
        ...
        <div className="mt-4 space-y-3 text-sm text-slate-700">
          <div>
            <p className="font-medium text-slate-900">Sources ({selectedSourceNames.length})</p>
            <p>{selectedSourceNames.join(", ")}</p>
          </div>
          <div>
            <p className="font-medium text-slate-900">Local Files ({uploadedFileCount})</p>
            <p>
              {uploadedFileCount === 0
